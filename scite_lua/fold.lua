...
-- If top level headings not present, toggle all folds does not work
--  we should keep track of lowest fold level and subtract if necessary
...
scite_Command {
  ...
  'Rescan Outline|process_file $(FilePath)',
}
